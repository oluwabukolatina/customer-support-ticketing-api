...
var AdminRequestService = require('../../../services/requests/admin/request.service');
/**
...
module.exports = /** @class */ (function () {
    ...
    CommentController.commentOnRequest = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var params, user, id, comment, data, request, updateRequest, updatedRequest, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        request = _a.sent();
                        if (!request)
                            res.status(404).json({ message: 'Request does not exist sooryy', status: false });
                        return [4 /*yield*/, CommentService.makeComment(data, id)];
                    case 3:
                        _a.sent();
                        if (!(request.status !== 'Resolving')) return [3 /*break*/, 5];
                        updateRequest = { status: 'Resolving' };
                        return [4 /*yield*/, AdminRequestService.attendToARequest(id, updateRequest)];
                    case 4:
                    ...
                    case 6:
                        ...
                        return [2 /*return*/, res
                                .status(400).json({
                                message: 'Something went wrong here while trying to make comment!',
                                status: false,
                            })];
